...
KNOWLEDGE_BASE = {
    "educational": {
        "examples": [
            ...
            "tabang eskwela", "tution fee", "pang eskwela"
        ],
        ...
        "response_sub": "Ang **Tabang sa Edukasyon** meg-hatag tabang pinansyal para sa mga bata ng eskwela. Kailangan: School ID, Sertipiko ng Enrolment, amba Sertipiko sa Kakabus (Indigency)."
    },
    "medical": {
        "examples": [
        ...
        "response_sub": "Ang **Tabang sa Medikal** meg-hatag tabang pambayad sa ospital amba bulong (tambal). Kailangan: Medical Certificate, Hospital Bill, amba Sertipiko sa Kakabus."
    },
    "burial": {
        "examples": [
        ...
        "response_sub": "Ang **Tabang Palubong** meg-hatag tabang sa pamilya sa minatay. Kailangan: Death Certificate, Kontrata sa Punerarya, amba Sertipiko sa Kakabus."
    },
    "transportation": {
        "examples": [
        ...
        "response_sub": "Ang **Tabang Pamasahe** meg-hatag tabang biyahe para sa masakit amba muuli. Kailangan: Referral Letter amba Valid ID."
    },
    "employment": {
        "examples": [
        ...
        "response_sub": "Ang **Tabang sa Trabaho** meg-hatag tabang panginabuhian. Kailangan: PSA Birth Certificate amba Resume."
    },
    "requirements": {
        "examples": [
        ...
        "response_sub": "Ang kailangan nagdepende sa programa. Kasagaran, kailangan niyo og **Sertipiko sa Kakabus** amba **Valid ID**."
    },
    "apply": {
        "examples": [
        ...
        "response_sub": "Aron mo-apply, sunda kini:\n1. Adto sa **Kwalipikasyon**.\n2. Susiha kung kwalipikado sa programa.\n3. I-upload ang mga kailangan na dokumento.\n4. Pindota ang **Ipasa Aplikasyon**."
    },
    "about_system": {
        "examples": [
        ...
        "response_sub": "Kani na sistema meg-hatag dalan para makapangayo tabang online sa gobyerno. Diri niyo isumite ang aplikasyon amba pangutana."
    },
    "programs_offered": {
        "examples": [
        ...
        "response_sub": "Kani ang mga tabang namo:\n1. Tabang Edukasyon\n2. Tabang Medikal\n3. Tabang Palubong\n4. Tabang Pamasahe\n5. Tabang Trabaho."
    },
    "office_info": {
        "examples": [
        ...
        "response_sub": "Ang opisina namo naa sa **City Hall, Ground Floor, Social Services Office**. Ang hepe karon kay si **Lanny M Cagatin**."
    },
    "get_requirements": {
        "examples": [
        ...
        "response_sub": "Ang mga kailangan sama sa **Certificate of Indigency** makuha sa inyo **Barangay Hall**. Ang medical certificate makuha sa **City Health Office**."
    },
    "online_assistance": {
        "examples": [
        ...
        "response_sub": "Aron mangutana sa admin, adto sa **Pangutana (Inquiries)** na bahin. Didto meg-tubag ang admin sa inyo mensahe."
    }
}
...
def analyze_intent(user_message, language="en"):
    ...
    if best_score < 0.15:
        ...
        fallback_sub = "Pasensya, daa nako nasabtan inyo pangutana. Pwede niyo pangutan-on ang mga programa sa: **Edukasyon, Medikal, Palubong, Pamasahe, o Trabaho**."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--lang", type=str, default="en", help="Language code (en or ceb or sub)")
