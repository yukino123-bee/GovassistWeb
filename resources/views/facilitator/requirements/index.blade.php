    ...
    <div class="lg:col-span-2 bg-white border border-slate-200 shadow-sm">
        <div class="px-6 py-4 border-b border-slate-100">
            <h3 class="text-xs font-extrabold text-slate-800 uppercase tracking-widest flex items-center">
                ...
                Existing Requirements Checklist
            </h3>
        </div>
                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse($requirements as $req)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-3.5 font-medium text-slate-600">{{ $req->service->name_en }}</td>
                            <td class="px-6 py-3.5">
                                @if($req->is_required)
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-slate-400 font-medium">No checklist requirements added yet.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
